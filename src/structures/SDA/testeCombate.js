...
const calculo = (origem = {}, [alvo = {}, action = '']) => {
    ...
    console.log(
        "Dano do ataque: " + dano,
        "Defesa do alvo: " + defesa,
    )
    const easterEgg = Math.floor(Math.random() * 100) + 1;
    if (action === 'bloqueio' && rng2 === 20) return {
        msg: easterEgg >= 90 ? 'Parry e Easter Egg. Sorte Máxima!\nhttps://youtu.be/C4gntXWPrw4' : 'Parry perfeito! PRIIIM!',
        payback: 'defesa'
    };
    else if (action === 'desvio' && rng2 === 20) return {
        msg: easterEgg >= 90 ? 'Desvio e Easter Egg. Sorte Máxima!\nhttps://www.youtube.com/shorts/bLC4F51xLVQ' : 'Esquiva perfeita! VOOSH!',
        payback: 'desvio'
    };
...
console.log(
    "Dano Infligido: " + calculo(jogador1, [jogador2, 'bloqueio'])
)